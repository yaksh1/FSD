...
<body>
	...
	}else if(status=="emptyMobile"){
		swal("Sorry","Please enter your mobile number","error");
	}else if(status=="passwordDontMatch"){
		swal("Sorry","Passwords entered do not match.Please check again.","error");
	}else if(status=="invalidMobileLength"){
		swal("Sorry","Invalid Mobile Number.Please check again.","error");
	}
	</script>
